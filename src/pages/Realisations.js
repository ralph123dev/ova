...
const projects = [
  ...
  },
  {
    ...
    tags: ['PGES', 'Infrastructures', 'PGES'],
    icon: '🛣️',
    color: 'sky',
  },
];
      ...
      <section className="section">
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '28px' }}>
            {projects.map((p, i) => (
              <article className="card" key={i} style={{ padding: '28px' }}>
                <div style={{
          ...
          <div className="text-center" style={{ marginTop: '56px' }}>
            <p style={{ color: 'var(--gray)', marginBottom: '20px' }}>Ces projets ne sont qu'un aperçu de notre expertise. Contactez-nous pour en savoir plus.</p>
