...
export default function Formation() {
  useEffect(() => {
    document.title = 'Formations — APAD Environnement';
  }, []);
          ...
          <div className="service-intro">
            <ScrollReveal direction="left">
              <div className="service-intro__text">
                ...
                <p className="section-subtitle">
                  APAD Environnement propose des programmes de formation de haute qualité, animés par des experts reconnus. Nos formations combinent théorie et pratique pour un impact immédiat sur le terrain.
                </p>
            ...
            <ScrollReveal direction="right">
              <div className="service-intro__visual service-intro__visual--blue">
                ...
                <div className="service-intro__stat"><strong>30+</strong><span>Formations dispensées</span></div>
                <div className="service-intro__stat"><strong>500+</strong><span>Participants formés</span></div>
              </div>
            </ScrollReveal>
          </div>
        </div>
