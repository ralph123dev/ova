...
export default function EtudesImpact() {
  useEffect(() => {
    document.title = "Études d'impact environnemental — APAD Environnement";
  }, []);
            ...
            <ScrollReveal direction="left">
              <div className="service-intro__text">
                ...
                <p className="section-subtitle">
                  APAD Environnement réalise des études d'impact environnemental de haute qualité, conformes aux exigences légales camerounaises et aux standards des bailleurs de fonds internationaux.
                </p>
