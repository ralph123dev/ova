...
const steps = [
  { step: '01', title: 'Diagnostic initial', desc: "Analyse approfondie de votre situation, identification des enjeux et définition des objectifs de votre projet.", icon: '🔍' },
  { step: '02', title: 'Montage du projet', desc: "Structuration du projet, élaboration du plan d'action, identification des partenaires et des sources de financement.", icon: '📋' },
  { step: '03', title: 'Conseil et expertise', desc: "Accompagnement réglementaire et administratif, assistance dans les démarches auprès des autorités compétentes.", icon: '⚖️' },
  { step: '04', title: 'Appui opérationnel', desc: "Suivi de la mise en œuvre, résolution des obstacles, coordination des parties prenantes jusqu'à la livraison.", icon: '🚀' },
];
...
export default function Accompagnement() {
  useEffect(() => {
    document.title = 'Accompagnement — APAD Environnement';
  }, []);
            ...
            <ScrollReveal direction="left">
              <div className="service-intro__text">
                ...
                <p className="section-subtitle">
                  APAD Environnement offre un accompagnement personnalisé et continu à chaque étape du développement de votre projet. De la conception à la réalisation, nous sommes à vos côtés.
                </p>
